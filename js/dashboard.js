...
transactionForm.addEventListener('submit', async (e) => {
    e.preventDefault();   // huudas refresh hiigdehiig zogsoono
    // talbaruudaas hereglegchiin oruulsan utguudiig unshih avah
    const type =txTypeInput.value;
    const category =txCategoryInput.value;
    const amount = parseFloat(txAmountInput.value);
    const date =txDateInput.value;
    const description =txDescInput.value;
    //guilgee nemeh gej bui nevtersen hereglegchiin medeelliig Supabase s avah
